...
**Phase 1 — Design document:** Reads template at `references/us设计.md`, outputs `./<变更描述>-us设计.md`.
**Approval gate:** User can confirm, request modifications (multi-round), or abort.
**Phase 2 — Task breakdown:** Reads confirmed design doc, uses template at `references/任务分解.md`, outputs `./<变更描述>-任务分解.md`. Tasks use T1/T2 numbering with dependency fields and DoD checklists (function/test/docs).
...
- **Default output**: design doc → `./<变更描述>-us设计.md`, task breakdown → `./<变更描述>-任务分解.md`.
